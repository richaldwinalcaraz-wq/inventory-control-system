...
const ICONS: Record<string, IconType> = {
  ...
  "/inventory/reorder-points": SlidersHorizontalIcon,
  "/reports/daily-exception": ClipboardTextIcon,
  "/reports/shrinkage-rate": TrendUpIcon,
  "/reports/damage-vs-shrinkage": FireIcon,
  "/reports/quarantine-disposal-aging": ClockCounterClockwiseIcon,
  "/reports/daily-stock-movement": ArrowsLeftRightIcon,
  "/reports/variance-analysis": ChartBarIcon,
  "/reports/trend-review": TrendUpIcon,
  ...
  return (
    <aside className="flex h-screen w-64 shrink-0 flex-col bg-brand-950 text-brand-50">
      ...
      <nav className="flex-1 space-y-1 px-3">
        {(["Main", "Reports"] as const).map((section) => (
          <div key={section}>
