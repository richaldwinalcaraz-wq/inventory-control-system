      ...
      <ActionCard key="gate" title="Gate check (outbound)">
        <div className="flex flex-col gap-2">
          <div>
            ...
            <input value={sealNumber} onChange={(e) => setSealNumber(e.target.value)} className="w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm" />
          </div>
          ...
          <div>
            ...
            <input type="number" step="any" value={actualWeightKg} onChange={(e) => setActualWeightKg(e.target.value)} className="w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm" />
          </div>
        </div>
        <button
