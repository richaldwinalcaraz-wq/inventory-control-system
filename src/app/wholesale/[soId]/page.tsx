    ...
    <main className="mx-auto max-w-3xl p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500">
          ...
          {order.spotRecountRequired ? <span className="ml-2 rounded bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-800">Spot recount flagged (G-10)</span> : null}
        </p>
      </div>
        ...
        <div className="mb-6">
          ...
          <ul className="flex flex-col gap-1">
            {order.releases.map((r) => (
              <li key={r.id}>
                <Link href={`/wholesale/releases/${r.id}`} className="text-sm text-blue-700 hover:underline">
